...
$clean = array_intersect_key($data, array_flip(['buildings', 'turret', 'mainHp', 'mainIdleSpeed', 'tierCosts', 'general', 'middles', 'middleEmpty', 'buildingSizes', 'tint', 'healthbarAlways', 'goldIcon', 'menuLogo', 'menuBtn', 'menuCard', 'menuBack', 'menuSlideFrame', 'menuFsBtn', 'menuSoundBtn', 'menuPwf', 'menuPlay', 'menuSetupFrame', 'menuOptionsFrame', 'menuRacePill', 'menuBg', 'loadingBg', 'loadingBgs', 'menuMusic', 'loadingTips', 'tutorials', 'unitOrder', 'music', 'abilities', 'upgrades', 'races']));
