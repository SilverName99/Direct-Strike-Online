...
$clean = array_intersect_key($data, array_flip(['buildings', 'turret', 'mainHp', 'mainIdleSpeed', 'tierCosts', 'general', 'middles', 'middleEmpty', 'buildingSizes', 'tint', 'healthbarAlways', 'fogOfWar', 'pushMode', 'pushCrossTeam', 'pushForce', 'goldIcon', 'menuLogo', 'menuBtn', 'menuCard', 'menuBack', 'menuSlideFrame', 'menuFsBtn', 'menuSoundBtn', 'menuPwf', 'menuPlay', 'menuSetupFrame', 'menuOptionsFrame', 'menuRacePill', 'menuRaceHumans', 'menuRaceOrcs', 'menuRaceUndead', 'menuBg', 'loadingBg', 'loadingBgs', 'menuMusic', 'menuMusicVol', 'loadingTips', 'tutorials', 'unitOrder', 'music', 'abilities', 'upgrades', 'races', 'aiGenome']));
