...
$clean = array_intersect_key($data, array_flip(['buildings', 'turret', 'mainHp', 'mainIdleSpeed', 'tierCosts', 'general', 'buildingSizes', 'tint', 'healthbarAlways', 'unitOrder', 'music', 'abilities', 'upgrades', 'races']));
