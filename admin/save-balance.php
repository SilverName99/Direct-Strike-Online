...
$clean = array_intersect_key($data, array_flip(['buildings', 'turret', 'mainHp', 'mainIdleSpeed', 'tierCosts', 'general', 'middles', 'middleEmpty', 'buildingSizes', 'tint', 'healthbarAlways', 'fogOfWar', 'pushMode', 'pushCrossTeam', 'pushForce', 'goldIcon', 'menuLogo', 'menuBtn', 'menuCard', 'menuBack', 'menuSlideFrame', 'menuFsBtn', 'menuLangRo', 'menuLangEn', 'menuSoundBtn', 'menuPwf', 'menuPlay', 'menuSetupFrame', 'menuOptionsFrame', 'menuRacePill', 'menuRaceHumans', 'menuRaceOrcs', 'menuRaceUndead', 'menuRaceWoodelves', 'menuBg', 'loadingBg', 'loadingBgs', 'menuMusic', 'menuMusics', 'menuMusicNames', 'menuMusicPrev', 'menuMusicNext', 'menuMusicVol', 'loadingTips', 'tutorials', 'unitOrder', 'music', 'abilities', 'upgrades', 'races', 'aiGenome']));
