...
export const CONFIG = {
  ...
  CONSTRUCTION_ZONE: [
    { x0: 560, x1: 960, y0: 80, y1: 880 },    // team 0 (left)
    { x0: 3120, x1: 3520, y0: 80, y1: 880 },  // team 1 (right, mirrored)
  ],
  ...
  MID_BUILD_ZONE: [
    { x0: 1260, x1: 1460, y0: 280, y1: 680 },
    { x0: 2620, x1: 2820, y0: 280, y1: 680 },
  ],
  ...
  BUILDINGS: {
    // walls scale with the OWNER's base tier, like towers: hp / hp2 / hp3
    // (each falls back to the lower tier when left unset)
    wall: { cost: 40, buildTime: 0, hp: 450, hp2: 450, hp3: 450, cw: 1, ch: 1, cap: 24, idleSpeed: 2, chainMax: 1, chainDelay: 3, regen: 0, name: 'Wall' },
    tower: {
    ...
    generator: {
      // like every other building, a mine RISES over buildTime: it pays no gold
      // and sends no miners until it's finished (admin-settable; 0 = instant)
      cost: 150, buildTime: 5, hp: 200, cw: 1, ch: 1, cap: 8, income: 80, buildCd: 0, idleSpeed: 2, name: 'Generator',
