...
export const UNITS = {
  grunt: {
    ...
    tip: 'Carne de tun ieftină pentru linia întâi. Moare la splash.',
    tipEn: 'Dirt-cheap frontline meat. Dies to splash.',
  },
  slinger: {
    ...
    tip: 'Trage în sol și aer. Fragil — ține-l în spatele liniei întâi.',
    tipEn: 'Shoots ground and air. Fragile — keep behind a frontline.',
  },
  bruiser: {
    ...
    role: 'Armored tank',
    tip: 'Zid de HP uriaș. Se topește la piercing (Lancer).',
    tipEn: 'Huge HP wall. Melts to piercing (Lancer).',
  },
  lancer: {
    ...
    projectile: true,
    role: 'Anti-armor',
    tip: 'Lovituri piercing — +50% pe armored. Slab contra roiurilor.',
    tipEn: 'Piercing shots — +50% vs armored. Weak vs swarms.',
  },
  crab: {
    ...
    tip: 'Splash exploziv cu rază lungă — șterge unitățile ușoare îngrămădite. Nu lovește aerul.',
    tipEn: 'Long-range explosive splash — deletes clumped light units. Cannot hit air.',
  },
  mender: {
    ...
    heal: true,
    role: 'Support healer',
    tip: 'Vindecă aliatul cel mai rănit din apropiere. Protejează-l.',
    tipEn: 'Heals the most wounded nearby ally. Protect it.',
  },
  dasher: {
    ...
    role: 'Fast flanker',
    tip: 'Foarte rapid — se aruncă în spatele liniei inamice (artilerie, vindecători).',
    tipEn: 'Very fast — dives the enemy backline (artillery, healers).',
  },
  wasp: {
    ...
    role: 'Air unit',
    tip: 'Zboară — melee-ul și artileria nu-l pot atinge. Contracarat de Slinger/Archon.',
    tipEn: 'Flies — melee and artillery cannot touch it. Countered by Slinger/Archon.',
  },
  archon: {
    ...
    tip: 'Raze piercing care lovesc aerul și solul. Răspunsul dedicat la Wasp.',
    tipEn: 'Piercing beams that hit air and ground. The dedicated Wasp answer.',
  },
  ...
  hero: {
    ...
    tipEn: 'A special unit, one per race. Levels up from your army\'s kills and learns abilities. Respawns every wave, keeping its level.',
  },
  ...
  hero2: {
    ...
    tipEn: 'The second hero — recruited from the Hero Hall once you reach tier 2.',
  },
  hero3: {
    ...
    tipEn: 'The third hero — recruited from the Hero Hall once you reach tier 3.',
  },
};
